...
describe('Mark as Priority', () => {
  ...
  it('should patch to api', () => {
    const endpoint = endpoints.getServiceProviders + '/coffee4craig/needs/abcde/is-priority'
    const patchedAsExpected = ajaxStub.withArgs(endpoint, { IsPriority: false }).calledOnce
